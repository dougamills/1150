...
//General Ideas:  at there broadest level, functions do the following:
...
let superImportantSentence = sentence('Nicky', 'Disbourough');
console.log (superImportantSentence);

//example three: let's build a function that takes a complex type--an array in this case, and console.logs eadh item in the input array
...
iteratorFunc(arr); //logs or returns contents of the first array "arr"
iteratorFunc(arr2);  //logs or returns contents of the second array "arr2"
