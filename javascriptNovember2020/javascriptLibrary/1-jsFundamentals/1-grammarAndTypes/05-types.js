...
1-gramarANDTYPES
    ...
    */
    ...
    //boolen can represent: true/false, yes/no, on/off, 0/1
...
/*
Null and undefined both represent variables with no value inside.  Think of it this way--null values are for gag fits that are boxes itentially given with othing inside.  (because that's the gag).  Undefined values are gifts given when the person given the gift has forgotten to put the gift inside (oops!).
*/
...
console.log(notQuite);
 ...
 //Strings
 //String is any value with quotes; JS spits out the value within the quotes
 let stringOne = "double quotes";
 let stringTwo = 'single quotes';
 console.log(stringOne, stringTwo);

 //string concatenation vs addtion
 let first = 1050 + 100;
 let second = '1050' + '100';
...
Denoted by []
Has values ('blue', 'green',  'yello'), separated by commas
*/

var stepsToBrushTeeth = ['uncap toothpaste', 'squeeze', 'rinse', 'brush']
//array indexing starts at    0                 1          2         3
