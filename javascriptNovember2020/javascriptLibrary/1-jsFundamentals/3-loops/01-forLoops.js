...
//loop structure: a)creation of an indexing variable  b) a run condition  c)change to the indexint variable
...
//loops can run infinitely and might look like this (but we don't want to do this...)
//for (let i = 0; ; i++){
//   console.log(i);   
//}
